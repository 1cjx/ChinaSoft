		...
		<el-row :gutter="20">
			<el-col :span="24" :xs="24">
				<el-form ref="queryForm" :model="queryParams" :inline="true" label-width="118px">
					<el-form-item label="洗手间设施名称" prop="name">
						<el-input v-model="queryParams.name" placeholder="请输入洗手间设施名称" clearable size="small"
				...
				<el-table :data="routeList" style="width: 100%" @selection-change="handleSelectionChange" v-loading="loading"
					...
					<el-table-column prop="longitude" label="经度" align="center" width="150" :show-overflow-tooltip="false" />
					<el-table-column prop="latitude" label="纬度" align="center" width="150" :show-overflow-tooltip="false" />
					<el-table-column prop="startTime" label="开放时间" align="center" width="150" :show-overflow-tooltip="false" />
					<el-table-column prop="closeTime" label="关闭时间" align="center" width="150" :show-overflow-tooltip="false" />
					<el-table-column v-if="0" prop="imageUrls" label="图片" align="center" :show-overflow-tooltip="true" />
					<el-table-column v-if="0" prop="expectTime" label="单次如厕时间" align="center" :show-overflow-tooltip="true" />
					<el-table-column v-if="0" prop="maxCapacity" label="可容纳人数" align="center" :show-overflow-tooltip="true" />
            ...
            <el-form-item label="结束时间" prop="closeTime">
              <el-time-picker
                ...
                />
						...
						<el-form-item label="单次如厕时间" prop="expectTime">
							<el-input v-model="form.expectTime" placeholder="单次如厕时间" maxlength="30" onkeyup="value=value.replace(/[^\d]/g,'')" />
						</el-form-item>
						<el-form-item label="可容纳人数" prop="maxCapacity">
							<el-input v-model="form.maxCapacity" placeholder="可容纳人数" maxlength="30" onkeyup="value=value.replace(/[^\d]/g,'')" />
						</el-form-item>
