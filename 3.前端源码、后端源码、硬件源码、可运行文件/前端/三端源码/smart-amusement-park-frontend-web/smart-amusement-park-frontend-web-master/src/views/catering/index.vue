		...
		<el-row :gutter="20">
			<el-col :span="24" :xs="24">
				<el-form ref="queryForm" :model="queryParams" :inline="true" label-width="96px">
					...
					<el-form-item label="美食设施名称" prop="name">
						<el-input v-model="queryParams.name" placeholder="请输入美食设施名称" clearable size="small"
              ...
              <el-option
				...
				<el-table :data="routeList" style="width: 100%" @selection-change="handleSelectionChange" v-loading="loading"
					...
					<el-table-column v-if="0" prop="expectTime" label="单次就餐时间" align="center" :show-overflow-tooltip="true" />
            ...
            <el-form-item label="结束时间" prop="closeTime">
              <el-time-picker
                ...
                />
						...
						<el-form-item label="单次就餐时间" prop="expectTime">
							<el-input v-model="form.expectTime" placeholder="单次就餐时间" maxlength="30" onkeyup="value=value.replace(/[^\d]/g,'')" />
						</el-form-item>
	...
	export default {
      ...
      getCaterings() {
        listFacilities().then((res) => {
					this.allCaterings = res.data;
          this.allCaterings.forEach(item=>{
